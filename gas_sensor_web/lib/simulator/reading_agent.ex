defmodule GasSensorWeb.Simulator.ReadingAgent do
  @moduledoc """
  ...
  ## Usage
      ...
      reading = GasSensorWeb.Simulator.ReadingAgent.get_reading()
      
      # Get just the PPM value
      ppm = GasSensorWeb.Simulator.ReadingAgent.get_ppm()
      
      # Update from GenServer (called internally)
      GasSensorWeb.Simulator.ReadingAgent.update(reading_map)
  ...
  ## Examples
      ...
      iex> GasSensorWeb.Simulator.ReadingAgent.time_reliable?()
      true
  """
